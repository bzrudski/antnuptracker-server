...
from django.contrib.auth.forms import UserCreationForm as BaseUserForm, PasswordResetForm as BasePasswordReset
...
class UserCreationForm(BaseUserForm):
    ...
    class Meta:
        model = User
        fields = ("username", "password1", "password2", "email", "professional", "institution", "description")
